...
const FAQS: Array<{ q: string; a: string }> = [
  ...
  },
  {
    ...
    a: "Бүх төлбөр wire.mn-ээр хийгдэнэ. Багц эсвэл түрээс сонгоход wire.mn төлбөрийн хуудас руу шилжинэ — тэндээс QR код уншуулах эсвэл банкныхаа аппыг сонгож төлнө. Төлбөр баталгаажмагц эрх тань автоматаар нээгдэнэ.",
  },
  {
