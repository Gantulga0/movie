...
const FAQS: Array<{ q: string; a: string }> = [
  {
    ...
    a: "Багцад орсон бүх кино, цуврал, өгүүллэгийг хугацааныхаа туршид хязгааргүй үзнэ. Зарим онцгой кино багцад ороогүй, зөвхөн түрээсээр гардаг тэдгээрийн постер дээр үнэ нь харагдана.",
  },
  {
    q: "Түрээс гэж юу вэ, хэрхэн ажилладаг вэ?",
    a: "Түрээс нь нэг кино болон өгүүллэгийг нэг удаагийн төлбөрөөр тодорхой хугацаанд үзэх эрх юм. Төлбөр баталгаажсан мөчөөс хугацаа тоологдож эхэлнэ, дуустал хэдэн ч удаа үзэж болно.",
  },
  {
    q: "Төлбөрөө хэрхэн төлөх вэ?",
    a: "Бүх төлбөр QPAY-ээр хийгдэнэ. Багц эсвэл түрээс сонгоход QR код уншуулах эсвэл банкныхаа аппыг сонгож төлнө. Төлбөр баталгаажмагц эрх тань автоматаар нээгдэнэ.",
  },
  {
