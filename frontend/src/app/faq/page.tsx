...
const FAQS: Array<{ q: string; a: string }> = [
  ...
  },
  {
    ...
    a: "Түрээс нь нэг кино болон бичвэрийг нэг удаагийн төлбөрөөр тодорхой хугацаанд үзэх эрх юм. Төлбөр баталгаажсан мөчөөс хугацаа тоологдож эхэлнэ, дуустал хэдэн ч удаа үзэж болно.",
  },
  {
